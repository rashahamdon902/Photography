...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41297951332226068781)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41297951433585068781)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41297951579086068781)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(41297951433585068781)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41297951693453068781)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(41297960294572068793)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41297955026693068785)
,p_name=>'P10010_APPLICATION_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(41297951332226068781)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41297955487347068785)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41297955857310068786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41297956275752068787)
...
,p_lov=>'.'||wwv_flow_api.id(41297956322601068787)||'.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41297958120930068789)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(41297959884038068793)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(41297951709989068781)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(41297951693453068781)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(41297958972487068791)
,p_event_id=>wwv_flow_api.id(41297951709989068781)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(41297959422488068792)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(41297951579086068781)

...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41297953482686068781)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(41297974204300068816)
,p_name=>'Manage Feedback'
...
,p_internal_uid=>41297974204300068816
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297974494213068816)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297974869951068818)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297975382098068819)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297976021476068820)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297976402782068821)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297976859581068822)
...
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_api.id(41297956322601068787)
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297977263490068823)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297978067748068824)
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_api.id(41297966559510068806)
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297978472329068824)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297978885843068825)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297979260213068826)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297979673913068827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41297980291654068828)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(41297981420875068831)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'412979815'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41297982702948068833)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(41297953482686068781)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(41297953324949068781)
,p_name=>'Refresh on Dialog Close'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(41297953482686068781)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(41297984178930068836)
,p_event_id=>wwv_flow_api.id(41297953324949068781)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(41297953482686068781)
);
